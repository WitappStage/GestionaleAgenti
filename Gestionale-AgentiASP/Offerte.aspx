<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Offerte.aspx.cs" Inherits="Gestionale_AgentiASP.Offerte" %>
...
<body style="height: ">
    ...
    <div style="height: 86px; text-align: center; width: 830px;">
        ...
        <asp:Label ID="lblTitolo" runat="server" Text="OFFERTE PRESENTATE AI CLIENTI" Font-Bold="True" Font-Size="XX-Large" Font-Names="Century Gothic"></asp:Label>
    
    </div>
        <asp:Panel ID="pnlInserisciOfferta" runat="server" Width="604px" BorderColor="#990000" BorderStyle="Solid" style="margin-left: 134px">
            <div>
                <asp:Label ID="lblIntestazione" runat="server" Text="Inserisci Offerta" Font-Bold="True" Font-Size="X-Large" Font-Names="Century Gothic"></asp:Label>
            ...
            <table style="width:100%; height: 104px;">
                ...
                <tr>
                 ...
                 <tr>
                     <td class="auto-style3">
                         <asp:Label ID="lblPreventivo" runat="server" Font-Names="Century Gothic" Text="Preventivo"></asp:Label>
                     </td>
                     <td style="font-family: 'Century Gothic'">
                         <asp:HyperLink ID="btnGeneraPreventivo" runat="server" BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px" Font-Italic="False" Font-Underline="False" ForeColor="#990000" NavigateUrl="~/Preventivo.aspx" style="text-align: center" Target="_blank" Width="130px">Genera</asp:HyperLink>
                     </td>
                 </tr>
                <tr>
                    <td class="auto-style8"><asp:Label ID="lblNote" runat="server" Text="Specifica la richiesta" Font-Names="Century Gothic"></asp:Label></td>
                    <td class="auto-style9" style="font-family: 'Century Gothic'">
                        <asp:TextBox ID="txtNote" runat="server" Height="40px" Width="415px" TextMode="MultiLine" Font-Names="Century Gothic"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3"><asp:Label ID="lblAllegato" runat="server" Text="Allega Preventivo" Font-Names="Century Gothic"></asp:Label></td>
                    <td style="font-family: 'Century Gothic'">
            ...
            <asp:Button ID="btnUpdate" runat="server" Text="SALVA MODIFICHE" Width="604px" Height="26px" OnClick="btnUpdate_Click" Font-Names="Century Gothic" Font-Bold="True" />
        </asp:Panel>
        ...
        <asp:GridView ID="grdListaOfferte" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="Black" BorderWidth="1px" CellPadding="4" Font-Names="Century Gothic" ItemType="LibreriaGestionaleAgente.Offerta" OnRowCommand="grdListaOfferte_RowCommand" ForeColor="Black">
            <Columns>
                ...
                <asp:BoundField DataField="Note" HeaderText="Richiesta" />
                <asp:BoundField DataField="Importo" HeaderText="Importo" />
                <asp:BoundField DataField="Mensile" HeaderText="Mensilità" />
                <asp:TemplateField>
                    <ItemTemplate>                        
                        <asp:Button ID="btnVediAllegato" runat="server" Text="Preventivo" Font-Names="Century Gothic" CommandArgument="<%# BindItem.Id %>" CommandName="VediAllegato" />
                    </ItemTemplate>
                </asp:TemplateField>
