<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Richieste.aspx.cs" Inherits="Gestionale_AgentiASP.Richieste" %>
...
<body style="height: ">
    ...
    <div style="text-align: center; width: 800px;">
        ...
        <asp:Label ID="lblTitolo" runat="server" Text="RICHIEDI OFFERTA" Font-Bold="True" Font-Size="XX-Large" Font-Names="Century Gothic"></asp:Label>
    
    </div>
        <asp:Panel ID="pnlInserisciRichiesta" runat="server" Width="604px" BorderColor="#990000" BorderStyle="Solid" style="margin-left: 134px">
            <div>
                <asp:Label ID="lblIntestazione" runat="server" Text="Inserisci Richiesta" Font-Bold="True" Font-Size="X-Large" Font-Names="Century Gothic"></asp:Label>
            ...
            <table style="width:100%; height: 104px;">
                ...
                <tr>
                 ...
                 <tr>
                     <td class="auto-style3">
                         <asp:Label ID="lblSettore" runat="server" Font-Names="Century Gothic" Text="Settore dell'azienda"></asp:Label>
                     </td>
                     <td style="font-family: 'Century Gothic'">
                         <asp:TextBox ID="txtSettore" runat="server" Font-Names="Century Gothic" Width="415px"></asp:TextBox>
                     </td>
                 </tr>
                <tr>
        ...
        <asp:GridView ID="grdListaRichieste" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="Black" BorderWidth="1px" CellPadding="4" Font-Names="Century Gothic" ItemType="LibreriaGestionaleAgente.Richiesta" OnRowCommand="grdListaRichieste_RowCommand" ForeColor="Black">
            <Columns>
                ...
                <asp:BoundField DataField="Settore" HeaderText="Settore" />
