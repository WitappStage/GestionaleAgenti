<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contratti.aspx.cs" Inherits="Gestionale_AgentiASP.Contratti" %>
...
<body style="height:">
    ...
    <div style="text-align: center; width: 800px;">
        ...
        <asp:Label ID="lblTitolo" runat="server" Text="CONTRATTI CONCLUSI" Font-Bold="True" Font-Size="XX-Large" Font-Names="Century Gothic"></asp:Label>
    
    </div>
        <asp:Panel ID="pnlInserisciContratto" runat="server" Width="604px" BorderColor="#990000" BorderStyle="Solid" style="margin-left: 134px">
            <div>
                <asp:Label ID="lblIntestazione" runat="server" Text="Inserisci Contratto" Font-Bold="True" Font-Size="X-Large" Font-Names="Century Gothic"></asp:Label>
            ...
            <table style="width:100%; height: 104px;">
                ...
                <tr>
                    <td class="auto-style3"><asp:Label ID="lblEsito" runat="server" Text="Stato" Font-Names="Century Gothic" Visible="False"></asp:Label></td>
                    <td style="font-family: 'Century Gothic'">
                        <asp:DropDownList ID="ddlEsito" runat="server" Font-Names="Century Gothic" Visible="False">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style8"><asp:Label ID="lblNote" runat="server" Text="Note" Font-Names="Century Gothic"></asp:Label></td>
                ...
                <tr>
                    <td class="auto-style3"><asp:Label ID="lblAllegato" runat="server" Text="Allega Contratto" Font-Names="Century Gothic"></asp:Label></td>
                    <td style="font-family: 'Century Gothic'">
        ...
        <asp:GridView ID="grdListaContratti" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="Black" BorderWidth="1px" CellPadding="4" Font-Names="Century Gothic" ItemType="LibreriaGestionaleAgente.Contratto" OnRowCommand="grdListaContratti_RowCommand" ForeColor="Black">
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:Button ID="btnVediAllegato" runat="server" Text="Contratto" Font-Names="century Gothic" CommandArgument="<%# BindItem.Id %>" CommandName="VediAllegato" />
                    </ItemTemplate>
                </asp:TemplateField>
